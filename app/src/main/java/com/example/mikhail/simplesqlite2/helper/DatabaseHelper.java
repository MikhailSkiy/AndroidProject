...
import com.example.mikhail.simplesqlite2.model.Todo.Todo;
import com.example.mikhail.simplesqlite2.model.Todo.Tag;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by Mikhail on 26.10.2014.
 */
 ...
 *
 * Example:
 * SELECT * FROM todos td, tags tg, todo_tags tt WHERE
 * tg.tag_name = ‘Watchlist’ AND tg.id = tt.tag_id AND td.id = tt.todo_id;
 * */
